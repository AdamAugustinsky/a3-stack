...
import type { Filter, FilterValue, FilterType } from '@/utils/filter';
	...
	return [
		...
		},
		{
			...
			action: () => {
				...
				applyFilter('status', 'is_not', 'done', 'select');
			},
		...
		},
		{
			...
			action: () => {
				...
				applyFilter('status', 'is', 'in progress', 'select');
			},
		...
		},
		{
			...
			action: () => {
				// Apply filter for status = done
				applyFilter('status', 'is', 'done', 'select');
			},
		...
		},
		{
			...
			action: () => {
				...
				applyFilter('priority', 'is', 'high', 'select');
			},
		...
		},
		{
			...
			action: () => {
				...
				applyFilter('label', 'is', 'bug', 'select');
			},
		...
		},
		{
			...
			action: () => {
				...
				applyFilter('label', 'is', 'feature', 'select');
			},
		...
		},
		{
			...
			icon: Calendar,
			action: () => {
				// Apply filter for createdAt = today
				applyFilter('createdAt', 'is_today', null, 'date');
			},
		...
		},
		{
			...
			icon: Calendar,
			action: () => {
				// Apply filter for createdAt = this week
				applyFilter('createdAt', 'is_this_week', null, 'date');
			},
